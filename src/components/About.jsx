...
function About() {
  return (
    <section id="hakkimda" className="min-h-screen bg-white dark:bg-gray-900 py-16 px-6 sm:px-12 ">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4 dark:text-white">Hakkımda</h2>
